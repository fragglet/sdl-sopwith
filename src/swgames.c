...
GAMES swgames[1] = {
	{
		...
		7491,
		{
			{TARGET,  191, 1}, {TARGET,  284, 3},
			{TARGET,  409, 1}, {TARGET,  539, 1},
			{TARGET,  685, 3}, {TARGET,  807, 0},
			{TARGET,  934, 1}, {TARGET, 1210, 2},
			{TARGET, 1240, 0}, {TARGET, 1440, 3},
			{TARGET, 1550, 3}, {TARGET, 1750, 0},
			{TARGET, 1780, 2}, {TARGET, 2024, 1},
